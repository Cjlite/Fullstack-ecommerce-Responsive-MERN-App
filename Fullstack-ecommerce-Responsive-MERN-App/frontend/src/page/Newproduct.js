...
const Newproduct = () => {
  ...
  console.log("REACT_APP_SERVER_DOMIN", process.env.REACT_APP_SERVER_DOMIN);
  const handleSubmit = async (e) => {
    ...
    if (name && image && category && price) {
      try {
        ...
        if (!fetchData.ok) {
          throw new Error(`Server error: ${fetchData.statusText}`);
        }
        ...
        toast("Error uploading product. Please try again later.");
      }
    } else {
